    ...
    render() {
        return(
            <Modal title="区域分布" key={this.props.newKey} visible={this.props.visible} onCancel={this.props.del} footer={null}>
                <div id="area"><Table rowKey={this.props.newKey} dataSource={this.props.modalSource} columns={diacolumns} onChange={this.props.onChange} pagination={this.props.pagination} /></div>
            </Modal>
        )
    }
};
